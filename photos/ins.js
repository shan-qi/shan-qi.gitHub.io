    ...
    var render = function render(res) {
      ...
      for (var j = 0, len2 = res.list.length; j < len2; j++) {
        ...
        for (var i = 0, len = data.link.length; i < len; i++) {
          var minSrc = 'hthttps://github.com/shan-qi/Blog-Back-Up/master/min_photos/' + data.link[i];
          var src = 'https://github.com/shan-qi/Blog-Back-Up/master/photos/' + data.link[i];
